            ...
            <div class="col-md-6 text-justify">
                ...
                <p class="mb-4">
                    <ul>
                        ...
                        <li>Constructor de consultas estad&iacute;sticas de manera gr&aacute;fica para el usuario com&uacute;n. (Sentencia SQL, cálculo de media, mediana, moda, desviaci&oacute;n est&aacute;ndar, y consultas utilizando cl&aacute;usulas condicionales y operadores l&oacute;gicos).</li>
                        <li>Exportaci&oacute;n de datos en CSV, JSON, XML, EXCEL, PDF y más.</li>
                    </ul>
                </p>

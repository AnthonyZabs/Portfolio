                    ...
                    <div class="row">
                        <div class="col-lg-8 text-center text-lg-start">
                            ...
                            <p class="mb-5 text-justify" data-aos="fade-right" data-aos-delay="100">
                                Hola, mi nombre es <i>Jos&eacute; Antonio Aguilar Z.</i>, y me encanta aprovechar mi tiempo libre para crear nuevas herramientas tecnológicas que puedan contribuir positivamente a la sociedad. 
                            </p>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center text-center mb-5">
                <div class="col-md-5" data-aos="fade-up">
                    <h2 class="section-heading">Sobre m&iacute;</h2>
                </div>
            </div>
            
            <div class="row text-justify">
                <div class="col-md-6 ms-auto order-2">
                    <h2 class="mb-4">Hola, mucho gusto.</h2>
                    <p class="mb-4">
                    Soy egresado de la carrera de Ingeniería en Sistemas Computacionales. Busco aplicar mis conocimientos teóricos y prácticos aprendidos durante mi formación académica con el fin de beneficiar a la sociedad y desarrollarme de forma personal y profesional.
                    </p>
                    <p class="mb-4">
                        Desde que comencé mi viaje como programador hace casi 10 a&ntilde;os, he trabajado a distancia para clientes, he trabajado en proyectos personales y he colaborado con personas talentosas para desarrollar aplicaciones y servicios de uso privado y comercial.
                    <p>
                </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
            <div class="col-md-5" data-aos="fade-up">
                ...
                <p class="mb-4">Aqu&iacute; hay algunos de los proyectos que he desarrollado. ¿Te gustaría ver más? <a href="">Cont&aacute;ctame</a></p>
            </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 me-auto text-center text-md-start mb-5 mb-md-0">
            <h2>Mant&eacute;nte en contacto</h2>
            <p class="mb-4">Puedes contactarme rellenando el siguiente formulario o si lo prefieres puedes comunicarte conmigo por correo electrónico:</p>
            <p>
                exapmple@company.com
            </p>
          </div>
          <div class="col-md-5">
